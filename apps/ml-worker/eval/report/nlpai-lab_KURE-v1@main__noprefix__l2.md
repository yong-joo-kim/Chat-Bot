# 임계값 스윕 보고서 — nlpai-lab/KURE-v1@main|noprefix|l2
...
- 배치 소요: 2.461s / 64건 (건당 38.45ms)
- 5,000건 재색인 추정 소요: **192.2초**
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 0.9 | 0.6 | 0.03 | 0.2333 | 0.9833 | 0.0 | 0.0167 | 0.875 | 1.0 | 0.9 | 0.025 | 1.1683 |
| 0.9 | 0.6 | 0.05 | 0.2333 | 0.9833 | 0.0 | 0.0167 | 0.875 | 1.0 | 0.9 | 0.025 | 1.1683 |
| 0.9 | 0.6 | 0.08 | 0.2333 | 0.9833 | 0.0 | 0.0167 | 0.875 | 1.0 | 0.9 | 0.025 | 1.1683 |
| 0.9 | 0.6 | 0.1 | 0.2333 | 0.9833 | 0.0 | 0.0167 | 0.875 | 1.0 | 0.9 | 0.025 | 1.1683 |
| 0.9 | 0.45 | 0.03 | 0.1833 | 0.9833 | 0.0 | 0.0167 | 0.9167 | 1.0 | 0.1 | 0.0 | 1.0983 |
...
- 근거: match_recall(즉시확정)=0.2333, match_handled_rate(확정+되묻기 회수)=0.9833, match_lost_rate(2단계로 새버림)=0.0, false_accept_rate=0.025(오확정 1건), clarify_recall=1.0, nomatch_recall=0.9
