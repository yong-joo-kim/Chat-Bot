 ...
 */
@Module({
  imports: [ChatbotsModule, BannedWordsModule, AnswerSettingsModule, EmbeddingModule, DialogueCommonModule, CannedResponsesModule, EnvironmentServingModule, WorkflowTriggersModule, InboxCoreModule],
