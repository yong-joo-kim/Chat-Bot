...
describe('hasPermission / ROLE_PERMISSIONS — ADR-0015', () => {
  ...
  it('ADMIN은 전체 권한(Permission 유니온, 환경분리 그룹부터 18종)을 전부 가진다(NFR-S5)', () => {
  ...
  it('Permission 유니온은 정확히 18종으로 고정된다(No.40 chatbot:deploy 신설로 17→18). 새 권한 추가/삭제 시 이 값도 의도적으로 갱신해야 한다', () => {
