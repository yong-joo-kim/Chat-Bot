...
describe('검증/품질 고도화 구조적 봉인 정적 검사 — ADR-0029/0030 §12', () => {
  ...
  it('8) validation/**에 legacy-api/ import가 0건이다(레거시 API 연동 No.26, FR-0-102 — TC/비교는 항상 목)', () => {
  ...
  it('10) validation/**에 handoff/·canned-responses/ import가 0건이다(하이브리드 CS No.24, FR-0-123 — DI 격리)', () => {
