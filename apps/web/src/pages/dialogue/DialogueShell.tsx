...
type SubNavKey = 'nodes' | 'intents' | 'homonyms' | 'contexts' | 'faqs' | 'surveys' | 'cannedResponses';
...
const SUBNAV_ITEMS: SubNavKey[] = ['nodes', 'intents', 'homonyms', 'contexts', 'faqs', 'surveys', 'cannedResponses'];
